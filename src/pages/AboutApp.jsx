...
<Layout>
    ...
    <div className={styles.main}>
        <div>
<img src="https://static.techspot.com/images2/news/bigimage/2018/07/2018-07-03-image-14.jpg" alt="o aplikacji"  className={styles.zdj}/> <br></br>
                        <div className={styles.text}>
                            <span className={styles.naglowek}>O aplikacji</span> <br></br>
                            <ul className={styles.lista}>
                       <li> Szukasz lepszego sposobu komunikacji z innymi?</li>
                        <li>Masz już dość cenzury na portalach społecznościowych?</li>
                        </ul>
                        Jeśli Twoje odpowiedzi na te pytania są twierdzące to posiadamy dla ciebie idealną odpowiedź - Textige! Jest to nowoczesna aplikacja pozwalająca jej użytkownikom na bezproblemowy kontakt z wybraną osobą. 
                        Została ona stworzona przez znaną profesjonalną grupę programistyczną B&P Coders.
                        W Textige wiemy że człowiek jest istotą funkcjonującą w społeczeństwie, a podstawowym środkiem do osiągnięcia przez jednostkę tego celu jest sprawne porozumiewanie się.
                        </div>
                        </div>
                        </div>
                        ...
                        <fieldset class="DeveloperIcons-module--main--3kNhn" className={styles.ikony}>
                            ...
                            </a> <a href="https://github.com/n00sek">
                        ...
                        <div className={styles.zakonczenie}>
                        Textige - wejdź na wyższy poziom komunikacji 💻
                        </div>
